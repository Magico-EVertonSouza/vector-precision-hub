...
const Contact = () => {
  ...
  const handleSendWhatsApp = () => {
    const text = 
      ...
      `🏢 Empresa: ${encodeURIComponent(formData.company)}\n` +
      `📞 Telefone: ${encodeURIComponent(formData.phone)}\n` +
      `⏰ Melhor horário: ${encodeURIComponent(formData.bestTime)}\n` +
      `💬 Mensagem: ${encodeURIComponent(formData.message)}`;

    // Abrir WhatsApp Web ou App
    window.open(`https://wa.me/351936660681?text=${text}`, "_blank");
      ...
      <div className="container mx-auto px-4">
        <div className="text-center space-y-4 mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Pronto para garantir o máximo desempenho das suas máquinas? Contacte-nos hoje mesmo via WhatsApp.
          </p>
        </div>
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-2xl font-bold text-primary mb-2">
                    Envie sua solicitação pelo WhatsApp
                  </h3>
                  <p className="text-muted-foreground">
                    Preencha os campos abaixo e clique em "Enviar via WhatsApp".
                  </p>
                </div>
