      ...
      <div className="container mx-auto px-4">
        <div className="text-center space-y-4 mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Soluções completas em manutenção de equipamentos de elevação para garantir o máximo desempenho.
          </p>
        </div>
            ...
            <Card key={index} className="group p-8 border-0 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <Button variant="vector" className="w-full" asChild>
                    <a 
                      href="https://wa.me/351936660681?text=Olá!%20Gostaria%20de%20um%20orçamento" 
                      target="_blank" 
        ...
        <div className="text-center mt-16">
          <Card className="p-8 bg-gradient-to-r from-primary to-primary-dark text-white">
            ...
            <Button variant="secondary" size="lg" asChild>
              <a 
                href="https://wa.me/351936660681?text=Olá!%20Gostaria%20de%20uma%20solução%20personalizada" 
                target="_blank" 
                rel="noopener noreferrer"
              >
